              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="/signup">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    <div className="border border-border bg-primary h-[40px] rounded-full flex items-center justify-center text-black">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center justify-center text-base">
                        Students
                      </p>
                    </div>
                ...
                <a href="/admin/login">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    <div className="border border-border bg-[#e78a53] h-[40px] rounded-full flex items-center justify-center text-black">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center justify-center text-base">
                        Admins
                      </p>
                    </div>
