        ...
        <Sidebar className="border-r border-border/20 bg-black/50 backdrop-blur-xl">
          <SidebarHeader className="border-b border-border/20 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground">Reinkei</h2>
                <p className="text-sm text-muted-foreground">Smart Campus Connection</p>
              </div>
            </div>
          </SidebarHeader>
        ...
        <div className="flex-1 w-full relative min-h-screen">
          ...
          >
            <a
              ...
              href="/"
            >
              <span className="text-2xl font-bold text-[#e78a53]">Reinkei</span>
            </a>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="/signup"
                className="rounded-md font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center bg-gradient-to-b from-[#e78a53] to-[#e78a53]/80 text-black shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] px-4 py-2 text-sm"
              >
                Sign Up
              </a>
            </div>
          ...
          <header className="sticky top-4 z-[9999] mx-4 flex w-auto flex-row items-center justify-between rounded-full bg-background/80 backdrop-blur-sm border border-border/50 shadow-lg md:hidden px-4 py-3">
            <a
              ...
              href="/"
            >
              <span className="text-xl font-bold text-[#e78a53]">Reinkei</span>
            </a>
